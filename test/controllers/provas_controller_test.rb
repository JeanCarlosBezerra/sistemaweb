...
class ProvasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prova" do
    assert_difference('Prova.count') do
      post provas_url, params: { prova: { disciplina: @prova.disciplina, nota: @prova.nota } }
    end
  ...
  test "should update prova" do
    patch prova_url(@prova), params: { prova: { disciplina: @prova.disciplina, nota: @prova.nota } }
