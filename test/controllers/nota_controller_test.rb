...
class NotaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create notum" do
    assert_difference('Notum.count') do
      post nota_url, params: { notum: { notaaluno: @notum.notaaluno, notalivro: @notum.notalivro, notatrabalhos: @notum.notatrabalhos } }
    end
  ...
  test "should update notum" do
    patch notum_url(@notum), params: { notum: { notaaluno: @notum.notaaluno, notalivro: @notum.notalivro, notatrabalhos: @notum.notatrabalhos } }
