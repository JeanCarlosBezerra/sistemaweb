...
class TrabalhosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create trabalho" do
    assert_difference('Trabalho.count') do
      post trabalhos_url, params: { trabalho: { dataentrega: @trabalho.dataentrega, descricao: @trabalho.descricao, disciplina: @trabalho.disciplina } }
    end
  ...
  test "should update trabalho" do
    patch trabalho_url(@trabalho), params: { trabalho: { dataentrega: @trabalho.dataentrega, descricao: @trabalho.descricao, disciplina: @trabalho.disciplina } }
